 //EPD_CS   = 5;  // to EPD CS    (CS)
//EPD_RST  = 17; // to EPD RST   (RES)
//EPD_DC   = 16; // to EPD DC    (DC)
//EPD_SCK  = 18; // to EPD CLK   (SCL)
//EPD_MOSI = 23; // to EPD DIN   (SDA)
...
void setupArrow(){
  display.clearDisplay();
  display.drawBitmap(0,5,symbols[1].bitmap, 64, 64, 1);
   display.display();
   delay(3000);
}
